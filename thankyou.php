...
<!DOCTYPE html>
<html>
<title>HG.com: Buy Products</title>
<meta charset="UTF-8">
...
$user=$_SESSION['email'];
include("db_conection.php");
$view_users_query="select * from cart_approval where p_email='$user'";
  ...
  ?>
        ...
        <tr>
          ...
          <td  colspan='3'><strong>Delivery Charge</strong></th>
            ...
            {
            echo"<h5>Your Order is Now on Pending...</h5>";
            }
            if($user_action=='Recieved')
            {
            echo"<h4>Order has been Confirmed</h4>
            <h4>status: shipping...</h4>";
            }
            if($user_action=='Delivered')
            {
            echo"<h4>Your Order Has Been Delivered</h4>
