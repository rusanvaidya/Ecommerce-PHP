...
<div class="f-40">
  <p>Limited Time 5% off</p>
</div>

<?php
$user=$_SESSION['email'];
include("db_conection.php");
$query ="SELECT * FROM upload WHERE id < '48' ORDER BY id DESC";
...
<div class="desc">
  ...
  <b style="text-decoration:line-through">Rs.<?php echo "$price"; ?></b><br>
  <b>Rs.</b><input type="number" name="price" value="<?php echo "$o_price"; ?>" readonly>
