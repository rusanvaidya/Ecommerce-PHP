...
<div class="f-30">
  ...
  $query ="SELECT * FROM upload WHERE category='Baby Care' ORDER BY id DESC";
  ...
  <div class="desc">
      ...
      <form method="POST">
    <input type="number" name="quantity" placeholder="Quantity" requirerd>
