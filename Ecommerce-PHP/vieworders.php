...
<br>
    ...
    <table class="table" style="color:black;">
        ...
        <tr>
            ...
            <th style="width:15%">View Orders</th>
        ...
        $view_users_query="select * from users where action='Recieved' OR action='Confirmed'";
        ...
        <tr>
            ...
            <td><a href="viewbills.php?bill=<?php echo $user_email ?>"><button class="button-3">View</button></a>
            </tr>
