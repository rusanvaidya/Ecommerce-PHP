...
<!DOCTYPE html>
<html>
<title>HG.com: Items Uploaded</title>
<meta charset="UTF-8">
...
<h1>Your Items</h1>
<div>
<a href="uploaditem.php" class="button-3">Upload Item</a>
</div>
<br>
<?php
$user=$_SESSION['email'];
include("db_conection.php");
$query ="SELECT * FROM upload WHERE email = '$user' ORDER BY id DESC";
...
<div class="desc">
  ...
  <input type="text" autocomplete="off" value="<?php echo "$item"; ?>" readonly>
  <b>Rs.</b><input type="number" value="<?php echo "$price"; ?>" readonly>
  <a href="s_delete_item.php?del=<?php echo $id; ?>"><button class="button-3"><i class="fa fa-close"></i></button></a>
</div>
</div>
<?php
}
